    ...
    function Tracery.CreateGrammar(grammar)
    ...
    local adDictionary = {
    	...
    	productAdjective = {"hot", "brand-new", "redesigned", "upgraded", "chic", "modern", "colorful", "hipster", "new-fangled", "shitty", "ass", "not good"},
    	emotionAdjective = {"sad", "miserable", "sorrow-filled", "empty", "shit", "not good", "sucks", "ass"},
    	verbCommand = {"need", "miss", "lack", "dont have", "(cheatname)-less"},
    	verb = {"taste", "fear", "adore", "eat", "buy", "consume", "steal", "consider", "remember", "serve", "die", "send", "expect", "sell", "love"},
    	noun = {"pineapple", "body lotion", "teddy bear", "pizza", "duck", "paper", "penis", "balls", "shit cheat", "pasted cheat", "good cheat", "detected cheat", "cheat", "hack", "dalbajobas"},
    	timeCommand = {"right now", " today", "this instant", "forever", "now", "10 years ago", "2 years ago", "never", "fuck you"}
    }
